...
@InputType()
class PredictionCreateNestedManyWithoutVehiclesInput {
...
export { PredictionCreateNestedManyWithoutVehiclesInput as PredictionCreateNestedManyWithoutVehiclesInput };
